        ...
        <div className="row ">
          <div className="col">
            <div className="card rounded-4 shadow-lg border-0 pb-5 px-3 px-md-4">
              <h1 className='pt-3 pb-5 fw-bold text-info'>Cash Receive</h1>
              <form onSubmit={handleSubmit} >
                ...
                <div className="row row-cols-1 row-cols-md-2 mb-3">
                  ...
                  <div className="col mt-3 mt-md-0">
                    <label htmlFor="salary" className="form-label"> Account Name</label>
                ...
                <div className="row row-cols-1 row-cols-md-2 mb-3">
                  ...
                  <div className="col mt-3 mt-md-0">
                    ...
                    <input type="text" className="form-control" id="item_type" name='item_type' value={state.item_type} onChange={handleChange} required />
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col">
                    ...
                    <div className="mb-3  ">
                      ...
                      <input type="text" className="form-control" id="description" name='description' value={state.description} onChange={handleChange} required />
                    </div>
                  </div>
                </div>
