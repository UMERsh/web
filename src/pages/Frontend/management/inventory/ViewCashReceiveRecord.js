...
export default function ViewCashReceiveRecord() {
  ...
  const gettingData = async () => {
    let array = []
    const querySnapshot = await getDocs(collection(firestore, "Cash-Receive"));
  ...
  return (
    <>
      <h3 className='fw-bold mb-4 text-info'>Cash Receive Record</h3>
