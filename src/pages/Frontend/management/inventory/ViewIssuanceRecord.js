...
export default function ViewIssuanceRecord() {
  ...
  const gettingData = async () => {
    let array = []
    const querySnapshot = await getDocs(collection(firestore, "Issuance"));
  ...
  return (
    <>
      <h3 className='fw-bold mb-4 text-info'>View Issuance Record</h3>
